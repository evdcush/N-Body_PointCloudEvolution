...
B0 = init_weight(*kdims[0],   BIAS_TAG.format(0))
H0 = activation(linear_layer(X_input, W0, B0))
'''
H0 -> left_mult(h, W) + b
# ValueError: Dimensions must be equal, but are 4096 and 6 for 'add' (op: 'Add') with input shapes: [?,4096,8], [6,8].
