...
print('Not saving truth test cube')
...
#vel_single_model_func(X_in, model_specs, coeff_idx):
X_preds = {i: nn.vel_single_model_func(*pred_in, coeff_idx=i) for i in range(num_rs_layers)}
...
for step in range(num_iters):
    ...
    for rsi, tup in enumerate(rs_tups):
        ...
        fdict = None # clear current fdict, just for safety
        zx, zy = tup
        # redshift
